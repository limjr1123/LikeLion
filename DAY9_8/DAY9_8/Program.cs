...
namespace DAY9_8
{
    class Skill
    {
        ...
        public int LastUsedTime;    //마지막 사용 시간(TickCount기준)
        ...
        public bool CanUse(int playerMana)
        {
            ...
            {
                Console.WriteLine($" 마나가 부족하다!(필요 MP : {ManaCost})");
                return false;
            }
            ...
            if(currentTime - LastUsedTime < Cooldown)
            {
                ...
                Console.WriteLine($"{ Name} 스킬은 아직 사용할 수 없다.(남은 시간 : {remainingTime}초)");
                return false;
            }
    ...
    class Program
    {
        ...
        {
            int playerMana = 200;   //풀레이어의 초기 마나
            ...
            {
                Console.Clear();
                Console.WriteLine($"현재MP : {playerMana}");
